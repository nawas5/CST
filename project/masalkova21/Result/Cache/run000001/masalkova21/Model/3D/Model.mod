...
With Brick
     ...
     .Component "component1" 
     .Material "material1" 
     .Xrange "-7.78/2", "7.78/2" 
     .Yrange "-9.86/2", "9.86/2" 
     .Zrange "0", "1.8" 
     .Create
End With
...
With Brick
     ...
     .Yrange "-lengthpatch/2", "lengthpatch/2" 
...
With Optimizer
  ...
  .ResetParameterList
  .SelectParameter "heigthsubstract", "False" 
  .SetParameterInit "1.8" 
  .SetParameterMin "1.62" 
  .SetParameterMax "1.98" 
  .SetParameterAnchors "5" 
  .SelectParameter "lengthground", "False" 
  .SetParameterInit "9.86" 
  .SetParameterMin "8.874" 
  .SetParameterMax "10.846" 
  .SetParameterAnchors "5" 
  .SelectParameter "lengthpatch", "True" 
  .SetParameterInit "5.2" 
  .SetParameterMin "4.68" 
  .SetParameterMax "5.72" 
  .SetParameterAnchors "5" 
  .SelectParameter "phi", "False" 
  .SetParameterInit "90" 
  .SetParameterMin "81" 
  .SetParameterMax "99" 
  .SetParameterAnchors "5" 
  .SelectParameter "teta", "False" 
  .SetParameterInit "0" 
  .SetParameterMin "-0.1" 
  .SetParameterMax "0.1" 
  .SetParameterAnchors "5" 
  .SelectParameter "theta", "False" 
  .SetParameterInit "0" 
  .SetParameterMin "-0.1" 
  .SetParameterMax "0.1" 
  .SetParameterAnchors "5" 
  .SelectParameter "widthground", "False" 
  .SetParameterInit "7.78" 
  .SetParameterMin "7.002" 
  .SetParameterMax "8.558" 
  .SetParameterAnchors "5" 
  .SelectParameter "widthpatch", "True" 
  .SetParameterInit "3.02" 
  .SetParameterMin "2.718" 
  .SetParameterMax "3.322" 
  .SetParameterAnchors "5" 
End With 
...
'@ delete monitor: e-field (f=18)

'[VERSION]2020.1|29.0.1|20191021[/VERSION]
Monitor.Delete "e-field (f=18)" 


'@ delete monitor: farfield (f=21)
